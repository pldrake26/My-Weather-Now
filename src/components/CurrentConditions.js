  ...
  render() {
    return (
      <div style={{margin: '3em', color: '#2065e6'}}>
        ...
        <TodaysCondition temp={this.state.temp} skies={this.state.skies} skiesIcon={this.state.skiesIcon} cloudiness={this.state.cloudiness} wind={this.state.wind} humidity={this.state.humidity} sunrise={this.state.sunrise} sunset={this.state.sunset} path={this.state.path} />
      </div>
    );
  }
}
